package com.ejercicio.PaquetitosRest.Rest;
...
import com.ejercicio.PaquetitosRest.Models.ClientesModel;
...
public class ClienteRest {
	...
	if (customers != null) {
	    ArrayList<Cliente> listaClientes = customers.lista(filter, limit, offset);
	...
	if (customers != null) {
	    Cliente cliente = customers.read(id);
	    if (cliente != null) {
